package ca.qc.cgmatane.informatique.gestionanniv3;
...
public class VueAnniv extends AppCompatActivity {
    ...
    static final public int ACTIVITE_MODIFIER_ANNIV = 0;
    static final public int ACTIVITE_AJOUTER_ANNIV = 1;
    ...
    //Intent intentionNaviguerModifierLivre = new Intent(VueAnniv.this, VueModifierAnniv.class);
